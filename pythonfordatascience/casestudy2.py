...
df["sex"].value_counts()
#df["sex"].value_counts(dropna=False) #nan değerleri de ayrı bir kategori olarak sayar
df["deck"].value_counts(dropna=False)
df.groupby("sex").count() #her sütunu cinsiyete göre gruplayıp sayısını gösterir
df.groupby("sex").size() # = df["sex"].value_counts()
...
df["pclass"].nunique() #unique değer sayısı

#########################################
# Görev 4: pclass değişkeninin unique değerleri bulunuz.
#########################################

df["pclass"].unique() #unique değerlerin kendisi

type(df["pclass"].unique()) #ndarray
